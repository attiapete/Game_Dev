...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void DestroyAll();
	// Hides all attachments (not the owner of the manager)
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void HideAllAttachments(bool bHide);
	// Hides the owner and all attachments
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void HideAll(bool bHide);
	// Set the collision for all attachments (not the owner of the manager)
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void SetCollisionAllAttachments(bool bEnable);
	// Set the collision for the owner and all attachments
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void SetCollisionAll(bool bEnable);
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
