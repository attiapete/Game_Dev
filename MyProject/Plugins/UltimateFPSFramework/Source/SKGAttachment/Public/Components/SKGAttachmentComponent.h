...
protected:
	...
	// If true, attachment compatibility is ignored
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGAttachment|Customization")
	bool bAllowAllAttachments {false};
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGAttachment|Customization", meta = (EditCondition = "!bAllowAllAttachments"))
	...
	UFUNCTION(Server, Unreliable, WithValidation)
	void Server_ClearCurrentAttachment();
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SKGAttachment|Attachment")
	FVector GetCustomizationOffsetLocation() const;
	...
	// Functions the same as DestroyCurrentAttachment but without destroying it
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void ClearCurrentAttachment();
	/**
	...
	**/
	...
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
	void SetPreviewAttachment(TSubclassOf<AActor> AttachmentClass);
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment")
