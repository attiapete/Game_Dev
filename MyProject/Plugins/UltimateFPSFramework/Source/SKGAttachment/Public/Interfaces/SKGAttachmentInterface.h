...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment|AttachmentInterface")
	void SetLoadDefaultAttachments(bool bLoadedByPreset);
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment|AttachmentInterface")
	bool GetShouldLoadDefaultAttachments();
	virtual bool GetShouldLoadDefaultAttachments_Implementation() { return true; }
};
