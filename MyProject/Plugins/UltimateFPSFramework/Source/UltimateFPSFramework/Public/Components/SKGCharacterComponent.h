...
DECLARE_STATS_GROUP(TEXT("SKGCharacterComponent"), STATGROUP_SKGCharacterComponent, STATCAT_Advanced);
...
protected:
	TObjectPtr<USKGCharacterAnimInstance> AnimationInstance;
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework|Default")
	FName FirstPersonMeshComponentName {"FPMesh"};
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework|Default")
	bool bAutoAttachOnEquipHeldActor;
	...
	AActor* HeldActor;
	UFUNCTION()
	virtual void OnRep_HeldActor(AActor* OldActor = nullptr);
	...
	UPROPERTY()
	TArray<TObjectPtr<AActor>> InfraredInfraredDevices;
	bool bNightVisionOn;
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SKGFPSFramework|CharacterComponent", meta = (DeprecatedFunction, DeprecationMessage="Init function has been deprecated and removed in the next few updates. Please use the Component Names given in the details panel for setup"))
	...
	*/
	...
	void SetCameraFOV(const float NewFOV) const;
};
